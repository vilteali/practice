...
public class ConcesionariaMain {
	...
	public static void main(String[] args) {
		...
		Vehiculo v1 = new Vehiculo("Peugeot", "206", 4, 200.00000);
		Vehiculo v2 = new Vehiculo("Honda", "Tital", "125cc", 60.00000);
		Vehiculo v3 = new Vehiculo("Peugeot", "208", 5, 250.00000);
		Vehiculo v4 = new Vehiculo("Yamaha", "YBR", "160cc", 80.50050);
